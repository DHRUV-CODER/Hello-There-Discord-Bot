...
class HelpCommands(commands.Cog):
    ...
    async def moderation(self,ctx):
        ...
        embed.add_field(name='av <user.mention> ', value='`Brings the Users Avatar`', inline=True)
        embed.add_field(name='warn <user.mention> ', value='`warns The Person`', inline=True)
    ...
    async def fun(self,ctx):
        ...
        embed.add_field(name='reddit_meme or reddit_meme <subreddit>', value="`Get's you the best Top 50 Subreddit.`", inline=False)
    ...
    async def help(self,ctx):
        ...
        embed.add_field(name='image', value='`Get some cute images and more`', inline=True)
        embed.add_field(name='set_prefix', value='`Customizes The Prefix For The Server`', inline=False)
    ...
    async def vb(self,ctx):
      embed=discord.Embed(title="free vbucks", url="https://www.youtube.com/watch?v=BLeOcCeqsfI", description="my man xaiver is giving some vbucks ", color=0xff0000)
      embed.set_author(name="Mr Xavier", icon_url="https://images-ext-2.discordapp.net/external/RQ1hLYGEF-gxzvmw2H_UjWqrsRiXfw9yPbyJjkpF-fM/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/701146789348376607/eb2b6e18558ff135e8ef5867e8adf7e8.webp")
      embed.set_thumbnail(url="https://cnet4.cbsistatic.com/img/aTLKqWz80LEDLhuX74RcgdKiXMM=/1200x675/2020/02/14/676146ec-f899-4c73-a132-99f7bff87827/vbucks.png")
      await ctx.send(embed=embed)
    ...
    async def image(self,ctx):
      embed=discord.Embed(title="Help On Images", description="API Request For Some Cool Stuff", color=0xccb044)
      embed.set_thumbnail(url="https://www.elemental.co.za/blog/wp-content/uploads/2020/04/api-2x.png")
      ...
      embed.add_field(name="pikachu", value="`get my cool shots`", inline=True)
      embed.add_field(name="trigger <link>", value="`get you a image with triggered edit`", inline=False)
      embed.add_field(name="pm <pokemon>", value="`Get Details About The Pokemon`", inline=False)
